...
var jwt = __webpack_require__(544);
...
function l(e) {
    ...
    let a = typeof e.client == "object" ? e.client : {}, o = z.object(a), v = z.object(e.server), s = e.isServer ?? "undefined" > "u", d = v.merge(o), i = s ? d.safeParse(r) : o.safeParse(r), f = e.onValidationError ?? ((t)=>{
        throw console.error("❌ Invalid environment variables:", t.flatten().fieldErrors), new Error("Invalid environment variables");
    }), p = e.onInvalidAccess ?? ((t)=>{
        throw new Error("❌ Attempted to access a server-side environment variable on the client");
    });
    return i.success === !1 ? f(i.error) : new Proxy(i.data, {
        get (t, n) {
            if (typeof n == "string") return !s && !n.startsWith(e.clientPrefix) ? p(n) : t[n];
        }
    });
}
var u = "NEXT_PUBLIC_";
...
const env = C({
   ...
   */ runtimeEnv: {
        ...
        NEXT_PUBLIC_IMAGE_BUCKET_BASE_URL: "http://127.0.0.1:9000/cacta-images/",
        ...
        NEXT_PUBLIC_MAPS_API_KEY: "AIzaSyAdDmh6536rpIv75AEL7zp4oUdF9F7cY6o",
        JWT_SECRET_KEY: process.env.JWT_SECRET_KEY,
        NEXT_PUBLIC_ENGINE_ENDPOINT: "https://cacta-django.onrender.com/platform"
    },
    skipValidation: process.env.IS_CI === "true"
});

;// CONCATENATED MODULE: ./src/utils/constants/routes.ts
const SIGN_IN = "/sign-in";
const HOME = "/";
const COMPLETE_SIGNUP = "/complete-signup";
const SETTINGS = "/settings";
const MONITOR = "/monitor";
const ANALYZE = "/analyze";
const REPORT = "/report";
const SUMMARY_BY_ESTABLISHMENT = "/summary-by-establishment";
const SUMMARY_BY_PRODUCT = "/summary-by-product";
const PERFORMANCE = "/performance";
const INITIATIVE_MANAGEMENT = "/initiative-management";
const ECO_SCORE = "/eco-score";
const PRODUCT_SCORE = "/product-score";
...
;// CONCATENATED MODULE: ../../node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2FUsers%2Ffelipeborras%2FDesktop%2Fcacta-platform%2Fapps%2Fnextjs&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dFxcLylbXi8uXXsxLH0pKSh8XFwuanNvbnxcXC8%2FaW5kZXh8XFwvP2luZGV4XFwuanNvbik%%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxjb25maXJtLWludml0ZXxpY29ucy8uKnxpbWFnZXMvLip8bG9jYWxlcy8uKikuKikifV0%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dFxcLylbXi8uXXsxLH0pKSh8XFwuanNvbnxcXC8%2FaW5kZXh8XFwvP2luZGV4XFwuanNvbik%%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxjb25maXJtLWludml0ZXxpY29ucy8uKnxpbWFnZXMvLip8bG9jYWxlcy8uKikuKikifV19!
...
var _interopRequireDefault = __webpack_require__(808);
...
var _jose = __webpack_require__(799);
var _hkdf = _interopRequireDefault(__webpack_require__(256));
var _uuid = __webpack_require__(831);
...
/******/ var __webpack_exports__ = (__webpack_exec__(772));
